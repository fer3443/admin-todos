...
//recordar que estoy del lado del servidor
...
export const TopMenu = () => {
  ...
  const cart = JSON.parse(cookieStore.get("cart")?.value ?? "{}"); //!con la validacion de null devuelvo una string con un obj y me aseguro que devuelva siempre algo
